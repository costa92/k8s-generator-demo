...
import (
	...
	versioned "github.com/costa92/k8s-generator-demo/code-generator-demo/pkg/generated/clientset/versioned"
	internalinterfaces "github.com/costa92/k8s-generator-demo/code-generator-demo/pkg/generated/informers/externalversions/internalinterfaces"
	v1alpha1 "github.com/costa92/k8s-generator-demo/code-generator-demo/pkg/generated/listers/appcontroller/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AppcontrollerV1alpha1().Applications(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AppcontrollerV1alpha1().Applications(namespace).Watch(context.TODO(), options)
			},
		},
