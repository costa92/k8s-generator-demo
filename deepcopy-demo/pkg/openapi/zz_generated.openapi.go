...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		"github.com/costa92/k8s-generator-demo/deepcopy-demo/pkg/apis/v1.NodeCache":       schema_deepcopy_demo_pkg_apis_v1_NodeCache(ref),
		"github.com/costa92/k8s-generator-demo/deepcopy-demo/pkg/apis/v1.NodeCacheList":   schema_deepcopy_demo_pkg_apis_v1_NodeCacheList(ref),
		"github.com/costa92/k8s-generator-demo/deepcopy-demo/pkg/apis/v1.NodeCacheSpec":   schema_deepcopy_demo_pkg_apis_v1_NodeCacheSpec(ref),
		"github.com/costa92/k8s-generator-demo/deepcopy-demo/pkg/apis/v1.NodeCacheStatus": schema_deepcopy_demo_pkg_apis_v1_NodeCacheStatus(ref),
...
func schema_deepcopy_demo_pkg_apis_v1_NodeCache(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
			...
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("github.com/costa92/k8s-generator-demo/deepcopy-demo/pkg/apis/v1.NodeCacheSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							...
							Default:     map[string]interface{}{},
							Ref:         ref("github.com/costa92/k8s-generator-demo/deepcopy-demo/pkg/apis/v1.NodeCacheStatus"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"github.com/costa92/k8s-generator-demo/deepcopy-demo/pkg/apis/v1.NodeCacheSpec", "github.com/costa92/k8s-generator-demo/deepcopy-demo/pkg/apis/v1.NodeCacheStatus", "k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta"},
	}
}

func schema_deepcopy_demo_pkg_apis_v1_NodeCacheList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "NodeCacheList is a collection of NodeCache.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
					...
					"items": {
						SchemaProps: spec.SchemaProps{
							Description: "items is the list of NCDataSet",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("github.com/costa92/k8s-generator-demo/deepcopy-demo/pkg/apis/v1.NodeCache"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"github.com/costa92/k8s-generator-demo/deepcopy-demo/pkg/apis/v1.NodeCache", "k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta"},
	}
}

func schema_deepcopy_demo_pkg_apis_v1_NodeCacheSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				Properties: map[string]spec.Schema{
					"datasets": {
						SchemaProps: spec.SchemaProps{
							Description: "dataset list Datasets []DataSetSummary `json:\"datasets,omitempty\" protobuf:\"bytes,1,opt,name=datasets\"`",
							Type:        []string{"string"},
							Format:      "",
						},
					},
...
func schema_deepcopy_demo_pkg_apis_v1_NodeCacheStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "NodeCacheStatus represents the status of NodeCche.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"unknown": {
						SchemaProps: spec.SchemaProps{
