...
import (
	...
	scheme "github.com/costa92/k8s-generator-demo/deepcopy-demo/pkg/generated/clientset/versioned/scheme"
...
func newNodeCaches(c *NodecachesV1Client, namespace string) *nodeCaches {
	return &nodeCaches{
		client: c.RESTClient(),
		ns:     namespace,
	}
